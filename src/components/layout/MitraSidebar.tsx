...
import { LayoutDashboard, Package, Settings, LogOut, ChevronLeft, Menu } from "lucide-react"
...
export default function MitraSidebar() {
  ...
  const links = [
    { name: "Dashboard", href: "/mitra/dashboard", icon: <LayoutDashboard className="w-5 h-5" /> },
    { name: "Input Stok Harian", href: "/mitra/stok", icon: <Package className="w-5 h-5" /> },
    { name: "Profil Usaha", href: "/mitra/profil", icon: <Settings className="w-5 h-5" /> },
  ]
